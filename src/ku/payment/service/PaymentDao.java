...
public interface PaymentDao {
	 ...
	 */
	public abstract PaymentTransaction find(long id);

	public abstract List<PaymentTransaction> findAll();

	public abstract List<PaymentTransaction> findByUser(long userID);
	 ...
	 */
	public abstract boolean save(PaymentTransaction payment);
	 ...
	 */
	public abstract boolean update(PaymentTransaction update);

...
public interface WalletTransactionDao {
	 ...
	 */
	public abstract WalletTransaction find(long id);

	public abstract List<WalletTransaction> findAll();
	 ...
	 */
	public abstract boolean save(WalletTransaction wallet);
	 ...
	 */
	public abstract boolean update(WalletTransaction update);
